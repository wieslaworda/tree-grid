...
checkpoint:
  ...
  gray_areas_resolved:
    ...
    - topic: "reguła domenowa"
      decision: "walidacja każdej zmiany struktury: blokada zapętleń + rozstrzygnięcie zakresu gałęzi"
    - topic: "drag&drop"
      decision: "ani wymaganie, ani wykluczenie — odłożone do Open Questions"
  frs_drafted: 10
...
- **Import listy obiektów z Excela** — obiekty powstają w aplikacji; ścieżka importu to osobny problem z własnym parsowaniem i walidacją.
...
1. **Czy budowa drzewa przez przeciąganie (drag&drop) wejdzie w zakres?** — Decyzja świadomie odłożona: drag&drop nie jest ani wymaganiem MVP, ani jawnym wykluczeniem. Owner: użytkownik. Wpływ: to najdroższy element interfejsu, więc decyzja przesuwa granicę 6-tygodniowego budżetu.
